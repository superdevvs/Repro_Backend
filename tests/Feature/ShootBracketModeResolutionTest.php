...
class ShootBracketModeResolutionTest extends TestCase
{
    ...
    private function service(string $name, int $photoCount, bool $usesHdrBrackets): Service
    {
    ...
    public function test_expected_raw_count_sums_each_service_at_its_own_size(): void
    {
        ...
        // Non-photo deliverables contribute nothing; they have no photo count.
        $this->item($shoot, $this->service('2D Floor Plan', 0, false));
        $this->item($shoot, $this->service('Virtual Tour (3D)', 0, false));
