...
@section('hero')
    <div style="text-align:center;">
        ...
        <p class="hero-title-td dark-title" style="margin:0; font-size:48px; line-height:0.98; font-weight:300; letter-spacing:-2.2px; color:#e8edf5;">Confirm your email</p>
        <p class="dark-body" style="margin:18px auto 0; max-width:480px; font-size:15px; line-height:1.8; color:#a9b8cb;">Verify this address so your schedule updates, invoices, delivery alerts, and dashboard notifications reach the right inbox.</p>
    </div>
@endsection
...
@section('content')
    <div style="text-align:center;">
        ...
        <p class="dark-body" style="margin:0 auto 8px; max-width:460px; font-size:16px; line-height:1.85; color:#a9b8cb;">
            Thanks for joining R/E Pro Photos.
        </p>
        <p class="dark-body" style="margin:0 auto 24px; max-width:460px; font-size:16px; line-height:1.85; color:#a9b8cb;">
        ...
        <p class="dark-muted" style="margin:0 auto 10px; max-width:460px; font-size:14px; line-height:1.8; color:#8298b4;">
            If the button does not work, copy and paste this link into your browser:
        </p>
        <p style="margin:0 auto; max-width:460px; font-size:13px; line-height:1.85;">
        ...
        <p class="dark-muted" style="margin:28px auto 0; max-width:460px; font-size:15px; line-height:1.8; color:#8298b4;">
            Thanks,<br>
