...
@section('hero')
    ...
    <p class="hero-title-td dark-title" style="margin:0; font-size:30px; line-height:1.1; font-weight:300; letter-spacing:-1.2px; color:#10192f;">Approvals digest for {{ $rangeStart->format('M d') }} - {{ $rangeEnd->format('M d, Y') }}</p>
