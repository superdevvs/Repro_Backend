...
@section('hero')
    ...
    <p class="dark-body" style="margin:20px 0 0; font-size:15px; line-height:1.8; color:#667a96;">This digest rolls up photographer and sales rep payout totals so accounting can review and release payments with confidence.</p>
@endsection
