...
@section('hero')
    ...
    <p class="hero-title-td dark-title" style="margin:0; font-size:30px; line-height:1.1; font-weight:300; letter-spacing:-1.2px; color:#10192f;">{{ !empty($isPhotographer) ? 'A shoot on your calendar has changed.' : 'One of your upcoming shoots has been updated.' }}</p>
@endsection
