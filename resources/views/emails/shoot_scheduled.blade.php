...
@section('hero')
    ...
    <p class="hero-title-td dark-title" style="margin:0; font-size:30px; line-height:1.1; font-weight:300; letter-spacing:-1.2px; color:#10192f;">{{ !empty($isPhotographer) ? 'You have been assigned to a new shoot.' : 'Your photo shoot is officially on the calendar.' }}</p>
