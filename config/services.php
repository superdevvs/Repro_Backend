...
return [
    ...
    */
    ...
    'fal' => [
        ...
        'outpaint_model' => env('FAL_OUTPAINT_MODEL', 'fal-ai/flux-2-pro/outpaint'),
        'reel_font' => env('FAL_REEL_FONT'),
        'workspace_queue_connection' => env('STUDIO_QUEUE_CONNECTION', 'studio'),
        'walkthrough_model' => env('FAL_WALKTHROUGH_MODEL', 'fal-ai/kling-video/v2.5-turbo/pro/image-to-video'),
